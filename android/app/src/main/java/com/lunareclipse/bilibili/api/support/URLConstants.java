...
public class URLConstants
{
    ...
    public static final String BILIBILI_VIDEO_PLAYURL = "http://interface.bilibili.com/playurl";
    public static final String BILIBILI_VIDEO_PLAYURL_M = "http://www.bilibili.com/m/html5";             //低清开放接口（已跪）
